...
public enum class ObdProtocols(public val displayName: String, internal val command: String) {
    // Unknown protocol
...
public enum class AdaptiveTimingMode(public val displayName: String, internal val command: String) {
    OFF("Off", "0"),
    AUTO_1("Auto 1", "1"),
    AUTO_2("Auto 2", "2"),
}

public enum class Switcher(internal val command: String) {
    ON("1"),
    OFF("0"),
}

public enum class Monitors(
    ...
    OXYGEN_SENSOR_HEATER("Oxygen Sensor Heater", true, 6),
